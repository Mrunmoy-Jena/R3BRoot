...
#define EXT_STR_h101_CALIFA_ITEMS_INFO(ok, si, offset, struct_t, printerr)                                             \
    ...
    {                                                                                                                  \
        ...
        EXT_STR_ITEM_INFO2_ZZP(                                                                                        \
            ok, si, offset, struct_t, printerr, CALIFA_ENEI, UINT32, "CALIFA_ENEI", "CALIFA_ENE", 0 /*flags*/);        \
        EXT_STR_ITEM_INFO2_ZZP(                                                                                        \
            ok, si, offset, struct_t, printerr, CALIFA_ENEv, UINT32, "CALIFA_ENEv", "CALIFA_ENE", 0 /*flags*/);        \
        EXT_STR_ITEM_INFO2_LIM(                                                                                        \
            ok, si, offset, struct_t, printerr, CALIFA_TOT, UINT32, "CALIFA_TOT", 5088, 0 /*flags*/);                  \
        EXT_STR_ITEM_INFO2_ZZP(                                                                                        \
            ok, si, offset, struct_t, printerr, CALIFA_TOTI, UINT32, "CALIFA_TOTI", "CALIFA_TOT", 0 /*flags*/);        \
        EXT_STR_ITEM_INFO2_ZZP(                                                                                        \
            ok, si, offset, struct_t, printerr, CALIFA_TOTv, UINT32, "CALIFA_TOTv", "CALIFA_TOT", 0 /*flags*/);        \
        EXT_STR_ITEM_INFO2_LIM(                                                                                        \
            ok, si, offset, struct_t, printerr, CALIFA_TSLSB, UINT32, "CALIFA_TSLSB", 5088, 0 /*flags*/);              \
        EXT_STR_ITEM_INFO2_ZZP(                                                                                        \
            ok, si, offset, struct_t, printerr, CALIFA_TSLSBI, UINT32, "CALIFA_TSLSBI", "CALIFA_TSLSB", 0 /*flags*/);  \
        EXT_STR_ITEM_INFO2_ZZP(                                                                                        \
            ok, si, offset, struct_t, printerr, CALIFA_TSLSBv, UINT32, "CALIFA_TSLSBv", "CALIFA_TSLSB", 0 /*flags*/);  \
        EXT_STR_ITEM_INFO2_LIM(                                                                                        \
            ok, si, offset, struct_t, printerr, CALIFA_TSMSB, UINT32, "CALIFA_TSMSB", 5088, 0 /*flags*/);              \
        EXT_STR_ITEM_INFO2_ZZP(                                                                                        \
            ok, si, offset, struct_t, printerr, CALIFA_TSMSBI, UINT32, "CALIFA_TSMSBI", "CALIFA_TSMSB", 0 /*flags*/);  \
        EXT_STR_ITEM_INFO2_ZZP(                                                                                        \
            ok, si, offset, struct_t, printerr, CALIFA_TSMSBv, UINT32, "CALIFA_TSMSBv", "CALIFA_TSMSB", 0 /*flags*/);  \
        EXT_STR_ITEM_INFO2_LIM(ok, si, offset, struct_t, printerr, CALIFA_NF, UINT32, "CALIFA_NF", 5088, 0 /*flags*/); \
        EXT_STR_ITEM_INFO2_ZZP(                                                                                        \
            ok, si, offset, struct_t, printerr, CALIFA_NFI, UINT32, "CALIFA_NFI", "CALIFA_NF", 0 /*flags*/);           \
        EXT_STR_ITEM_INFO2_ZZP(                                                                                        \
            ok, si, offset, struct_t, printerr, CALIFA_NFv, UINT32, "CALIFA_NFv", "CALIFA_NF", 0 /*flags*/);           \
        EXT_STR_ITEM_INFO2_LIM(ok, si, offset, struct_t, printerr, CALIFA_NS, UINT32, "CALIFA_NS", 5088, 0 /*flags*/); \
        EXT_STR_ITEM_INFO2_ZZP(                                                                                        \
            ok, si, offset, struct_t, printerr, CALIFA_NSI, UINT32, "CALIFA_NSI", "CALIFA_NS", 0 /*flags*/);           \
        EXT_STR_ITEM_INFO2_ZZP(                                                                                        \
            ok, si, offset, struct_t, printerr, CALIFA_NSv, UINT32, "CALIFA_NSv", "CALIFA_NS", 0 /*flags*/);           \
        EXT_STR_ITEM_INFO2_LIM(                                                                                        \
            ok, si, offset, struct_t, printerr, CALIFA_TRG, UINT32, "CALIFA_TRG", 5088, 0 /*flags*/);                  \
        EXT_STR_ITEM_INFO2_ZZP(                                                                                        \
            ok, si, offset, struct_t, printerr, CALIFA_TRGI, UINT32, "CALIFA_TRGI", "CALIFA_TRG", 0 /*flags*/);        \
        EXT_STR_ITEM_INFO2_ZZP(                                                                                        \
            ok, si, offset, struct_t, printerr, CALIFA_TRGv, UINT32, "CALIFA_TRGv", "CALIFA_TRG", 0 /*flags*/);        \
        EXT_STR_ITEM_INFO2_LIM(ok, si, offset, struct_t, printerr, CALIFA_OV, UINT32, "CALIFA_OV", 5088, 0 /*flags*/); \
        EXT_STR_ITEM_INFO2_ZZP(                                                                                        \
            ok, si, offset, struct_t, printerr, CALIFA_OVI, UINT32, "CALIFA_OVI", "CALIFA_OV", 0 /*flags*/);           \
        EXT_STR_ITEM_INFO2_ZZP(                                                                                        \
            ok, si, offset, struct_t, printerr, CALIFA_OVv, UINT32, "CALIFA_OVv", "CALIFA_OV", 0 /*flags*/);           \
        EXT_STR_ITEM_INFO2_LIM(                                                                                        \
            ok, si, offset, struct_t, printerr, CALIFA_WRTS_T1, UINT32, "CALIFA_WRTS_T1", 5088, 0 /*flags*/);          \
        ...
        EXT_STR_ITEM_INFO2_ZZP(ok,                                                                                     \
                               ...
                               0 /*flags*/);                                                                           \
        EXT_STR_ITEM_INFO2_LIM(                                                                                        \
            ok, si, offset, struct_t, printerr, CALIFA_WRTS_T2, UINT32, "CALIFA_WRTS_T2", 5088, 0 /*flags*/);          \
        EXT_STR_ITEM_INFO2_ZZP(ok,                                                                                     \
                               si,                                                                                     \
                               offset,                                                                                 \
                               struct_t,                                                                               \
        ...
        EXT_STR_ITEM_INFO2_ZZP(ok,                                                                                     \
                               ...
                               0 /*flags*/);                                                                           \
        EXT_STR_ITEM_INFO2_LIM(                                                                                        \
            ok, si, offset, struct_t, printerr, CALIFA_WRTS_T3, UINT32, "CALIFA_WRTS_T3", 5088, 0 /*flags*/);          \
        EXT_STR_ITEM_INFO2_ZZP(ok,                                                                                     \
                               si,                                                                                     \
                               offset,                                                                                 \
                               struct_t,                                                                               \
        ...
        EXT_STR_ITEM_INFO2_ZZP(ok,                                                                                     \
                               ...
                               0 /*flags*/);                                                                           \
        EXT_STR_ITEM_INFO2_LIM(                                                                                        \
            ok, si, offset, struct_t, printerr, CALIFA_WRTS_T4, UINT32, "CALIFA_WRTS_T4", 5088, 0 /*flags*/);          \
        EXT_STR_ITEM_INFO2_ZZP(ok,                                                                                     \
                               si,                                                                                     \
                               offset,                                                                                 \
                               struct_t,                                                                               \
        ...
        EXT_STR_ITEM_INFO2_ZZP(ok,                                                                                     \
                               ...
                               0 /*flags*/);                                                                           \
        EXT_STR_ITEM_INFO2_LIM(                                                                                        \
            ok, si, offset, struct_t, printerr, CALIFA_PILEUP, UINT32, "CALIFA_PILEUP", 5088, 0 /*flags*/);            \
        EXT_STR_ITEM_INFO2_ZZP(ok,                                                                                     \
                               si,                                                                                     \
                               offset,                                                                                 \
                               struct_t,                                                                               \
        ...
        EXT_STR_ITEM_INFO2_ZZP(ok,                                                                                     \
                               ...
                               0 /*flags*/);                                                                           \
        EXT_STR_ITEM_INFO2_LIM(                                                                                        \
            ok, si, offset, struct_t, printerr, CALIFA_DISCARD, UINT32, "CALIFA_DISCARD", 5088, 0 /*flags*/);          \
        EXT_STR_ITEM_INFO2_ZZP(ok,                                                                                     \
                               si,                                                                                     \
                               offset,                                                                                 \
                               struct_t,                                                                               \
